...
**VO:** "Let's start at the top: The Backoffice Portal. Think of this as your global HQ. Here, you get a bird's-eye view of your entire empire."

**Visual:** Highlight the left-hand navigation menu, specifically clicking on **Establishments**, **Brands**, and **Employees**.
**VO:** "From here, you can group your locations into 'Brands', manage global staff members across the organization, define account-level access roles, and handle your centralized billing and subscriptions. It's multi-location management made effortless."

## Part 4: The Establishment Dashboard (Daily Operations)
**Visual:** The cursor clicks to enter a specific store. Transition to the **Establishment Dashboard** (`/dashboard`). The screen displays the main POS view with a category-based grid of vibrant product images.
**VO:** "Now, let's zoom in on the day-to-day operations: The Establishment Dashboard. This is your daily operating OS."

### Sub-section: The POS & Orders
**Visual:** The cursor clicks on a product (e.g., 'Cheeseburger'). A popup appears showing modifiers ("Extra Cheese", "Medium Rare"). The item is added to the cart.
...
**VO:** "Managing your team is built right in. Employees can clock in and out directly on the POS. You can define highly granular custom roles—so your Head Barista can process refunds, but a new trainee cannot."

**Visual:** Show the End of Day / Shift Closure process.
**VO:** "At the end of the shift, the cash reconciliation process ensures every penny is accounted for, automatically calculating any discrepancies and alerting management."

### Sub-section: CRM & Reporting
**Visual:** Quick cut to the **Customers Page** (`/dashboard/customers`), showing a VIP profile. Then cut to the **Reports Page** (`/dashboard/reports`) with colorful charts.
**VO:** "Turn first-time buyers into regulars with our built-in CRM and Loyalty program. Track customer spend, automatically assign VIP tiers, and let them earn points. Finally, our powerful Reports suite provides real-time analytics on sales trends, inventory costs, and labor efficiency."
...
### Production Notes for the Video Editor:
*   **Pacing:** Ensure the screen recordings move at a natural pace. Don't rush through complex popups like the `ProductFormModal`.
*   **Callouts:** Use subtle highlighting (like a soft glow or a zooming circle) when the voiceover mentions specific features like 'Modifiers', 'Offline Mode', or the 'Z-Report' reconciliation.
*   **Transitions:** Use smooth sliding transitions when moving between the 'Backoffice Portal' and the 'Establishment Dashboard' to visually separate the HQ view from the local store view.