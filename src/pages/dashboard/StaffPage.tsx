    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium mt-1">Manage staff access, roles, and system permissions.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <div key={i} className="p-6 rounded-3xl bg-white dark:bg-[#0A0A0A] border border-gray-200 dark:border-white/5 shadow-md hover:shadow-lg hover:border-gray-300 dark:hover:border-white/10 transition-all">
                    ...
                    <td className="px-8 py-5 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          className="p-2.5 rounded-xl bg-gray-200 dark:bg-white/5 border border-gray-300 dark:border-transparent text-gray-600 dark:text-gray-500 hover:text-paymint-green hover:bg-paymint-green/10 hover:border-paymint-green/30 transition-all"
                        >
                          <Edit2 size={16} />
                        </button>
                        <button
                          onClick={() => handleDelete(member.id, member.username)}
                          className="p-2.5 rounded-xl bg-gray-200 dark:bg-white/5 border border-gray-300 dark:border-transparent text-gray-600 dark:text-gray-500 hover:text-paymint-red hover:bg-paymint-red/10 hover:border-paymint-red/30 transition-all"
                        >
                          <Trash2 size={16} />
                        </button>
                        <button className="p-2.5 rounded-xl bg-gray-200 dark:bg-white/5 border border-gray-300 dark:border-transparent text-gray-600 dark:text-gray-500">
