            ...
            <div className="bg-white dark:bg-[#1E293B] rounded-2xl border border-gray-200 dark:border-white/5 overflow-hidden shadow-sm">
                {isLoading ? (
                    <div className="py-32 flex flex-col items-center">
                        ...
                        <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Loading cluster registry...</p>
                    </div>
                ) : adminUsers.length === 0 ? (
                            ...
                            <form onSubmit={handleSubmit} className="p-8 space-y-6">
                                ...
                                {!editingAdmin && (
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-[9px] font-bold text-gray-400 mt-1 px-1 uppercase tracking-tight">
                                ...
                                <div className="pt-6 flex gap-4">
                                    <button
                                        type="button"
                                        onClick={() => setShowModal(false)}
                                        className="flex-1 py-4 bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400 font-black uppercase tracking-[0.2em] text-[10px] rounded-xl hover:text-gray-900 dark:hover:text-white transition-all border border-gray-200 dark:border-white/5"
                                    >
                                        Abort
                                    </button>
                                    <button
                                        ...
                                        className="flex-1 py-4 bg-paymint-green text-black font-black uppercase tracking-[0.2em] text-[10px] rounded-xl hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-paymint-green/20"
                                    >
