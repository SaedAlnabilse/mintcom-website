...
import { Eye, EyeOff, ArrowLeft, Mail, Lock, User, Phone, Check } from 'lucide-react';
...
export function SignUpPage() {
        ...
        >
          ...
          <div className="bg-gray-700/50 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-300">
              ...
              <button className="text-green-500 hover:underline">resend verification</button>
            </p>
          </div>
          <Link
            to="/login"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Start your 7-day free trial. No credit card required.</p>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  {...register('lastName')}
                  type="text"
                  className="w-full bg-gray-700/50 border border-gray-600 rounded-lg py-3 px-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  placeholder="Doe"
                />
                {errors.lastName && (
      ...
      {/* Right Side - Benefits */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-green-600/20 to-green-600/5 items-center justify-center p-8">
        <div className="max-w-md">
          <h2 className="text-3xl font-bold text-white mb-8">Everything you need to run your business</h2>
