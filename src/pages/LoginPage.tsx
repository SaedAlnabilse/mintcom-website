        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg shadow-gray-200/50 dark:shadow-none p-8 transition-colors duration-300 border border-gray-200 dark:border-white/10">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full bg-paymint-green text-black text-sm font-outfit font-bold tracking-tight hover:bg-paymint-green/90 disabled:opacity-50 disabled:cursor-wait py-5 rounded-xl transition-all shadow-md shadow-paymint-green/20"
            >
