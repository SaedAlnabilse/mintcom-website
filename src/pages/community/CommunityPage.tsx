      ...
      <section className="pt-32 pb-20 bg-gradient-to-b from-gray-50 to-white dark:from-[#0a0a0a] dark:to-[#050505] relative overflow-hidden">
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24 relative z-10">
          ...
          >
            ...
            <h1 className="font-barlow text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-6">
        ...
        <div className="container mx-auto px-8 md:px-16 lg:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="font-barlow text-2xl font-black mb-3 group-hover:text-blue-500 transition-colors">
            ...
            >
              ...
              <h3 className="font-barlow text-2xl font-black mb-3 group-hover:text-yellow-500 transition-colors">
            ...
            >
              ...
              <h3 className="font-barlow text-2xl font-black mb-3 group-hover:text-Mintcom-green transition-colors">
      ...
      <section className="py-20 bg-gray-50 dark:bg-white/[0.02]">
        <div className="container mx-auto px-8 md:px-16 lg:px-24">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="font-barlow text-2xl md:text-3xl font-black tracking-tight mb-2">
            ...
            {featuredDiscussions.map((discussion, index) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="font-barlow font-bold text-lg mb-3 group-hover:text-Mintcom-green transition-colors">
                    {discussion.title}
                  </h3>
              ...
              {topIdeas.map((idea, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="font-barlow font-bold">{idea.title}</h4>
                  </div>
                  <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {popularGuides.map((guide, index) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="font-barlow font-bold group-hover:text-Mintcom-green transition-colors">
                      {guide.title}
                    </h4>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl p-10 md:p-16 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="font-barlow text-3xl md:text-4xl font-black mb-4">
