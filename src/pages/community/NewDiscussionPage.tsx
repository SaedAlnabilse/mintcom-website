                ...
                <main className="pt-40 pb-20">
                    <div className="container mx-auto px-8 md:px-16 lg:px-24">
                        ...
                        >
                            ...
                            <h1 className="font-barlow text-3xl font-black mb-4 tracking-tight">Members Only Space</h1>
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="mb-8">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h1 className="font-barlow text-3xl font-black tracking-tight">{t('community.discussions.submitTitle', 'Start a Discussion')}</h1>
                            </div>
