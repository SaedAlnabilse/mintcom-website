                            ...
                            <div className="flex-1">
                                ...
                                <section>
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <h2 className="font-barlow text-2xl font-black">{discussion.repliesCount} {t('community.labels.replies', 'Replies')}</h2>
                                    </div>
                            ...
                            <div className="lg:w-72">
                                <div className="sticky top-28 space-y-6">
                                    ...
                                    <div className="bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-6 shadow-sm">
                                        <h3 className="font-barlow text-xs font-black uppercase tracking-widest text-gray-400 mb-6 italic">{t('community.labels.activity', 'Thread Activity')}</h3>
                                        <div className="space-y-6">
                                    ...
                                    <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-3xl p-6 text-white relative overflow-hidden shadow-xl shadow-purple-500/20">
                                        ...
                                        <h4 className="font-barlow font-black text-lg mb-3 relative z-10">{t('community.cta.joinHero', 'Join this conversation')}</h4>
