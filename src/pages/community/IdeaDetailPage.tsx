                            ...
                            <div className="lg:w-72">
                                <div className="sticky top-28 space-y-6">
                                    ...
                                    <div className="bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-6 shadow-sm">
                                        <h3 className="text-sm font-black uppercase tracking-widest text-gray-400 mb-6">{t('community.labels.ideaStats', 'Analytics')}</h3>
                                        <div className="space-y-6">
                                    ...
                                    {/* Similar Ideas */}
                                    <div className="bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-3xl p-6 shadow-sm">
                                        <h3 className="text-sm font-black uppercase tracking-widest text-gray-400 mb-6">{t('community.labels.similarIdeas', 'Similar Ideas')}</h3>
