...
const SECURITY_HEADERS: Record<string, string> = {
    ...
    'Content-Security-Policy': [
        ...
        "form-action 'self'",
        "img-src 'self' data: blob: https://mintcompos.com https://www.mintcompos.com https://upload.wikimedia.org https://cdn-icons-png.flaticon.com https://accounts.google.com https://*.googleusercontent.com https://www.gstatic.com https://ssl.gstatic.com",
        ...
        "script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://connect.facebook.net https://accounts.google.com https://apis.google.com https://www.gstatic.com",
        "connect-src 'self' https://grateful-liberation-production-d036.up.railway.app wss://grateful-liberation-production-d036.up.railway.app https://accounts.google.com https://*.googleapis.com https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://connect.facebook.net",
