...
import { CreditCard, Package, Users, BarChart3, TrendingUp, Sparkles } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex items-start gap-4 mb-3">
        ...
        <h3 className="font-barlow text-gray-900 dark:text-white font-bold text-base mt-2 group-hover:text-mintcom-green transition-colors leading-tight">
          {feature.title}
        </h3>
      </div>
      
      <div className="flex-1 flex flex-col justify-between">
        <p className={`font-barlow text-gray-500 dark:text-gray-400 text-sm leading-relaxed transition-all duration-300 ${!isExpanded && shouldTruncate ? 'line-clamp-2' : ''}`}>
          {description}
        </p>
        ...
        {shouldTruncate && (
          <button
            ...
            className="mt-2 text-xs font-bold font-barlow text-mintcom-green hover:text-mintcom-green/80 self-start transition-colors focus:outline-none"
          >
...
export const WorkflowSupport = () => {
  ...
  return (
    <>
      <section className="py-16 lg:py-28 bg-white dark:bg-[#0f0f0f] overflow-hidden relative" dir={t('common.locale') === 'ar' ? 'rtl' : 'ltr'}>
        {/* Background Decor */}
        ...
        <div className="container mx-auto px-6 md:px-10 lg:px-16 max-w-[1280px]">
          <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-16">
            ...
            >
              <div className="relative group w-full flex items-center justify-center sticky top-24">
                <img 
                  src="/phone_notifications_showcase.png" 
                  alt="Workflow and Notifications Showcase" 
                  className="w-full max-w-[520px] lg:max-w-none h-auto object-contain drop-shadow-2xl transform transition-transform duration-700 group-hover:scale-105"
