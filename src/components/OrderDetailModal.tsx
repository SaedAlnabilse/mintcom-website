                ...
                <div className="p-8 border-b border-gray-100 dark:border-white/5 flex items-center justify-between relative isolate">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Transaction Log</span>
                            <span className="w-1 h-1 rounded-full bg-gray-300 dark:bg-white/20" />
                            <span className="text-[10px] font-black text-paymint-green uppercase tracking-widest">Protocol Active</span>
                        </div>
                ...
                <div className="p-8 space-y-10">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <span
                                className={`inline-flex px-2 py-0.5 text-[9px] font-black uppercase tracking-widest rounded-md border ${getStatusColor(
                        ...
                        <div>
                            ...
                            <p className="text-sm font-bold text-gray-900 dark:text-white uppercase">{order.paymentMethod}</p>
                        </div>
                        <div>
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-1">
                                Operator
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest">Inventory Manifest</h3>
                        </div>
                    ...
                    <div className="bg-gray-900 dark:bg-black p-8 rounded-2xl space-y-4 shadow-xl relative overflow-hidden isolate">
                        ...
                        <div className="flex justify-between text-white font-bold text-xl pt-6 border-t border-white/10 mt-2">
                            <span className="flex items-center gap-2">
                                ...
                                <span className="text-xs font-black uppercase tracking-[0.2em]">Net Settlement</span>
                            </span>
                    ...
                    {order.note && (
                        <div>
                            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1">Special Directives</p>
                    ...
                    <div className="flex gap-4 pt-4">
                        <button
                            onClick={onClose}
                            className="flex-1 py-4 px-6 bg-gray-100 dark:bg-white/5 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl transition-all border border-gray-200 dark:border-white/5 active:scale-95 shadow-sm"
                        >
                            Close Entry
                        </button>
                        {(order.paymentStatus === 'COMPLETED' || order.status === 'COMPLETED') && (
                            <button
                                ...
                                className="flex-1 py-4 px-6 bg-paymint-red/10 text-paymint-red hover:bg-paymint-red hover:text-white font-black uppercase tracking-[0.2em] text-[10px] rounded-2xl transition-all border border-paymint-red/20 active:scale-95 shadow-lg shadow-paymint-red/10"
                            >
                                Reverse Protocol
                            </button>
                        )}
