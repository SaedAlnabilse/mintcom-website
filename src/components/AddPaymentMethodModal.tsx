                ...
                <>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
                        <motion.div
                            ...
                            className="bg-white dark:bg-[#1E293B] rounded-[2rem] border border-gray-200 dark:border-white/10 shadow-2xl w-full max-w-md pointer-events-auto overflow-hidden relative"
                        >
