        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    style={style}
                    className={`dropdown-container bg-white dark:bg-zinc-900/60 border border-stone-200 dark:border-zinc-800 rounded-xl shadow-md overflow-hidden ${width} ${maxHeight} ${className}`}
                >
                    {children}
                </motion.div>
            )}
