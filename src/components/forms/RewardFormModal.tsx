            ...
            <div className="space-y-2">
              ...
              <div className="flex p-1 bg-gray-50 dark:bg-black/20 rounded-xl border border-gray-200 dark:border-white/5 relative isolate">
                <button
                  ...
                  className={`relative flex-1 py-3 rounded-lg font-outfit font-bold text-xs tracking-widest transition-all duration-300 z-10 ${type === 'DISCOUNT' ? 'text-black' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'
                    }`}
                >
                  {type === 'DISCOUNT' && (
                ...
                <button
                  ...
                  className={`relative flex-1 py-3 rounded-lg font-outfit font-bold text-xs tracking-widest transition-all duration-300 z-10 ${type === 'FREE_ITEM' ? 'text-black' : 'text-gray-500 hover:text-gray-900 dark:hover:text-white'
                    }`}
                >
                  {type === 'FREE_ITEM' && (
                    <motion.div layoutId="active-reward-type" className="absolute inset-0 bg-mintcom-green rounded-lg -z-10 shadow-sm" transition={{ type: 'spring', bounce: 0.2, duration: 0.6 }} />
