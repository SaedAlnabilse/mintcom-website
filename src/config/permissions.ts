...
export const POS_PERMISSIONS = [
  { id: 'open_cash_drawer', label: 'Open Drawer Without Making Sale', description: 'Open drawer without making a sale' },
  { id: 'change_taxes', label: 'Change Tax Rate in Order', description: 'Change tax rate in the current order' },
  { id: 'pay_in_pay_out', label: 'Pay-In/Pay-Out (Non-Sales Transactions)', description: 'Record pay in and pay out entries' },
...
export const BACKOFFICE_PERMISSIONS = [
  ...
  { id: 'manage_payment_methods', label: 'Manage Payment Methods', description: 'Configure accepted payment types like Cash, Card, and digital methods' },
  { id: 'manage_employees', label: 'Manage Employees', description: 'Create and manage staff accounts and their access permissions' },
  { id: 'manage_discounts', label: 'Discounts, Loyalty and Customers', description: 'Manage promotional discounts, loyalty points, rewards, and the customer database' },
  ...
  { id: 'manage_tax_currency', label: 'Tax and Currency', description: 'Set up regional tax rates and currency display options' },
