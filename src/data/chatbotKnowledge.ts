...
هذا المسار مخصص لإنشاء موقع جديد بالكامل. أما ربط موقع موجود وغير مرتبط بعلامة تجارية فهو خطوة مختلفة.`,
  ...
  {
    id: 'create-brand',
    keywords: ['create brand', 'new brand', 'add brand', 'brand setup', 'set up brand', 'إنشاء علامة تجارية', 'علامة تجارية جديدة', 'إضافة علامة تجارية', 'إعداد علامة تجارية'],
    question: 'How do I create a brand?',
    questionAr: 'كيف أنشئ علامة تجارية؟',
...
**وضع عدم الاتصال:** مينتكوم يعمل بدون إنترنت للمبيعات النقدية الأساسية! البيانات تتزامن عند الاتصال مجدداً.`,
  ...
  {
    id: 'session-expired',
    keywords: ['session expired', 'signed out', 'login again', 'session timeout', 'انتهت الجلسة', 'تسجيل خروج تلقائي', 'مهلة الجلسة'],
    question: 'I got signed out/session expired. Why?',
...
**الإدارة:** انتقل إلى **المالك > الفوترة** لعرض الخطط وتبديل دورة الفوترة وتحديث طرق الدفع وتنزيل الفواتير.`,
  ...
  // ========== MISC ==========
  {
    ...
    answer: `Email us at **info@mintcompos.com**. Include: error message, steps taken, device info, screenshots. We respond within 24 hours!`,
    answerAr: `راسلنا على **info@mintcompos.com**. أرفق: رسالة الخطأ، الخطوات المتخذة، معلومات الجهاز، لقطات شاشة. نرد خلال 24 ساعة!`,
    category: 'technical'
  },
  {
    id: 'activity-logs',
  ...
  },
  {
    ...
    answer: `Never share your password. Sign out when leaving POS unattended. Report suspicious activity. Change password if compromised. Close shifts before leaving. Admins: review the activity log regularly.`,
