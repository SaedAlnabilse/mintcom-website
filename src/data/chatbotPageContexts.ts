...
const PAGE_CONTEXTS: ChatbotPageContextDefinition[] = [
  ...
  },
  {
    ...
    match: ['/dashboard/:locationSlug/settings', '/dashboard/:locationSlug/settings/:section'],
    ...
    quickActions: [
      {
        ...
        icon: 'store',
        type: 'navigate',
        path: '/dashboard/:locationSlug/settings/profile',
      },
      {
        id: 'settings-sales',
        label: text('Tax settings', 'إعدادات الضريبة'),
        icon: 'creditCard',
        type: 'navigate',
        path: '/dashboard/:locationSlug/settings/sales',
      },
      {
        id: 'settings-receipt',
        ...
        icon: 'receipt',
        type: 'navigate',
        path: '/dashboard/:locationSlug/settings/receipts',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    defaultSuggestions: [
      ...
      text('I got signed out/session expired. Why?', 'تم تسجيل خروجي أو انتهت الجلسة. لماذا؟'),
    ],
    quickActions: [
      {
        id: 'login-password',
