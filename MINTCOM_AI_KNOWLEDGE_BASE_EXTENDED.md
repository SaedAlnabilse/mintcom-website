# Mintcom AI Knowledge Base (Extended)

This document is the **definitive source of truth** for the Mintcom AI Chatbot. It contains deep technical details, feature specifications, data models, and operational logic derived from the codebase and test suites.
...
- **Code:** `<script src="https://sa3d100-Mintcom-test.hf.space/widget.js"></script>`
- **Placement:** Before closing `</body>` tag.
- **Function:** Embeds a subset of Mintcom functionality into external sites.
...
### 7.2 Resources
- **Manual:** `public/docs/Mintcom-user-manual.md` (PDF available).
- **Contact:** support@Mintcom.io or in-app "Contact Support".
